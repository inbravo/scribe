 ...
 * 
 */
public final class MSCRMV5OpportunityService extends MSCRMObjectService {

  private final Logger logger = Logger.getLogger(MSCRMV5OpportunityService.class.getName());
  ...
  public MSCRMV5OpportunityService() {
    super();
  }
