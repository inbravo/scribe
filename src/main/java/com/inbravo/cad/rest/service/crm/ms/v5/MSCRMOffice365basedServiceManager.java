...
import com.inbravo.cad.rest.service.crm.ms.MSCRMSchemaConstants.MSCRM_2011_Schema_Constants;
import com.inbravo.cad.rest.service.crm.ms.MSCRMSchemaConstants.MSCRM_SAML_Constants;
  ...
  private final OrganizationServiceStub createOrganizationServiceStub(final String organizationServiceURL, final String[] securityTokens,
    ...
    try {
      ...
      try {
        ...
        throw new CADException(CADResponseCodes._1002 + "'MS_Session_Timeout' in edsa.properties");
      }
